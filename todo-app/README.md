...
8. We cannot save the Task class objects in the json file. Instead, we must return a dictionary. To convert, I have added a to_dict method in Task class. This will return a dictionary from class properties. Pydantic is a data validation library like we use zod in Javascript. We can use pydantic base class within Task class so that we can use the to_dict function of pydantic to get the dictionary.
